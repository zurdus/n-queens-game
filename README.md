...
- Keep presentation independent of Navigation Compose: screens and routes expose named callbacks and never receive a `NavController`.
...
- `com.zurdus.nqueens.feature.boardsize.presentation`: board-size route, state, and ViewModel
